...
def get_fake_data(data_path,sequence,bili):
...
class ps_pred(nn.Module):
    ...
    def __init__(self,in_dim,seq_len,
        ...
        self.cnn1 = cnn1##128
        self.num_layers = 2
        self.hidden_size = ln_hiddensize##128
...
if __name__ == '__main__':
    ...
    '''
    gen_fake_weight_path = "/remote-home/21310019/2024/pv_TSTR/TS/model_2/gen/"
    #gen_real_weight_path = "/remote-home/21310019/2024/passenger_flow/TSTR/TR/model_withoutga/gen/"
    loss_path = "/remote-home/21310019/2024/pv_TSTR/TS/model_2/loss/"
    fig_path =  "/remote-home/21310019/2024/pv_TSTR/TS/model_2/eval/"
    ...
    for j in range(7,8):
        ...
        for i in range(1):
            ...
            #gen_real_weight_path = "/remote-home/21310019/2024/passenger_flow/TSTR/TR/model_withoutga/gen/"
            loss_path = "/remote-home/21310019/2024/pv_TSTR/TS/model_0827/nn_{}to_1/loss_no_{}/".format(j+1,i+1)
            ...
            trainx,trainy= get_fake_data(sequence=4,
            ...
            loss_fake = eval(eval_epoch=2500,pred_num=BATCH_SIZE,fig_path=fig_path,test_data=test_data_real,gen = gen,
                            gen_weight_path=gen_fake_weight_path,signal="fake_no_{}".format(i+1))
            loss_dic[f"fake_to_real_{j+1}_bi_1"].append(loss_fake)
            with open("/remote-home/21310019/2024/pv_TSTR/TS/20240827_different_fake_nums", "a") as file:
                file.write(f"NO.{i+1}_ts_loss when fake_to_real_is_{j+1}_bi_1 is {loss_fake}\n")
